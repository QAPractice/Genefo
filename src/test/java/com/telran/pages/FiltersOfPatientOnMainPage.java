...
public class FiltersOfPatientOnMainPage extends Page {
    ...
    public boolean isNameOfPatOne(String name){return this.verifyTextBoolean(nameOfPatOnePost,name);}

    public boolean isNameOfPatTwo(String name){return this.verifyTextBoolean(nameOfPatTwoPost,name);}

    public boolean isNameOfPatThree(String name){return this.verifyTextBoolean(nameOfPatThreePost,name);}

    public boolean isNameOfPatFour(String name){return this.verifyTextBoolean(nameOfPatFourPost,name);}
